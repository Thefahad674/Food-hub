...
const Login = () => {
  ...
  return (
   ...
   <div class="relative flex h-[700px] w-full">
    ...
    className='absolute top-5 right-6 text-2xl   text-amber-600 hover:text-amber-800' />
    ...
    <div class="w-full flex flex-col items-center justify-center">
        ...
        <form class="md:w-96 w-80 flex flex-col items-center justify-center">
            ...
            <p class="text-sm text-gray-500/90 mt-3">Welcome back! Please Login in to continue</p>

            <button type="button" class="w-full mt-8 bg-gray-200 flex items-center justify-center h-12 rounded-full hover:bg-gray-300 cursor-pointer">
                <img src="https://raw.githubusercontent.com/prebuiltui/prebuiltui/main/assets/login/googleLogo.svg" alt="googleLogo"/>
            </button>

            <div class="flex items-center gap-4 w-full my-5">
                <div class="w-full h-px bg-gray-300/90"></div>
                <p class="w-full text-nowrap text-sm text-gray-500/90">or login in with email</p>
                <div class="w-full h-px bg-gray-300/90"></div>
            </div>
            ...
            <button type="submit" className="w-full py-3 mt-5 bg-gradient-to-r from-amber-500 to-amber-600 text-white font-bold rounded-full shadow-lg hover:shadow-amber-300/50 hover:from-amber-600 hover:to-amber-700 transition-all">
                Login
            </button>
            <p class="text-gray-500/90 text-sm mt-4">Don’t have an account? <a class="text-amber-600 hover:underline hover:text-amber-400" href="#">Sign up</a></p>
        </form>
    </div>
</div>
   </>
